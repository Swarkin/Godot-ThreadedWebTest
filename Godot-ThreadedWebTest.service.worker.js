...
/** @type {string} */
const CACHE_VERSION = '1727286277|36116571';
/** @type {string} */
const CACHE_PREFIX = 'Godot-ThreadedWe-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Godot-ThreadedWebTest.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Godot-ThreadedWebTest.html","Godot-ThreadedWebTest.js","Godot-ThreadedWebTest.offline.html","Godot-ThreadedWebTest.worker.js","Godot-ThreadedWebTest.audio.worklet.js","Godot-ThreadedWebTest.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Godot-ThreadedWebTest.wasm","Godot-ThreadedWebTest.pck"];
